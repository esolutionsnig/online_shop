...
import 'package:online_shop/src/widgets/BottomNavigationBar/bottom_curved_painter.dart';
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
  ...
  double _indexToPosition(int index) {
    // Calculate button positions based off of their index (works with 'MainAxisAlignment.spaceAround)
  ...
  void _handlePressed(int index) {
    ...
    Future.delayed(
      ...
      () {
        _yController.animateTo(1.0, duration: Duration(microseconds: 1200));
      },
    );
    _yController.animateTo(0.0, duration: Duration(microseconds: 300));
  }
